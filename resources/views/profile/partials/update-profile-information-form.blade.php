            ...
            <div class="lg:col-span-8 space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        <label for="name" class="block text-base font-bold text-slate-655 uppercase tracking-wider mb-2">Nombre Completo</label>
                        <div class="relative">
                    ...
                    <div>
                        <label for="email" class="block text-base font-bold text-slate-655 uppercase tracking-wider mb-2">Correo Institucional</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <x-input-error class="mt-1.5 text-sm text-rose-600" :messages="$errors->get('email')" />
                    ...
                    <div>
                        <label for="telefono" class="block text-base font-bold text-slate-655 uppercase tracking-wider mb-2">Teléfono de Contacto</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="md:col-span-2">
                        <label for="cedula_display" class="block text-base font-bold text-slate-655 uppercase tracking-wider mb-2">Cédula de Identidad (No modificable)</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
