    ...
    <div class="space-y-6 max-w-8xl mx-auto pb-12">
        ...
        <div class="bg-white border border-slate-200/80 shadow-sm rounded-2xl overflow-hidden">
            <div class="p-6 border-b border-slate-100 bg-slate-50/50">
                ...
                <p class="text-base text-slate-550 font-bold uppercase tracking-wider mt-0.5">Actualiza los detalles del programa académico seleccionado para mantener la coherencia en los registros de tesis</p>
            </div>
            ...
            <form action="{{ route('admin.programs.update', $program) }}" method="POST" class="p-8 space-y-6">
                ...
                <div>
                    ...
                    <textarea id="description"
                              ...
                              class="block w-full px-4 py-3 bg-white border border-slate-200 rounded-xl text-base focus:border-unimar-blue focus:outline-none focus:ring-2 focus:ring-[#0d4d98]/50 transition duration-150 text-slate-700 font-medium placeholder-slate-400">{{ old('description', $program->description) }}</textarea>
                    @error('description')
                        <p class="text-base text-rose-600 font-bold mt-1.5">{{ $message }}</p>
                    @enderror
                </div>
