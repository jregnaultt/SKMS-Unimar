                    ...
                    <div class="p-6">
                        <div class="mb-6">
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                                Define la vigencia cronológica del nuevo período.
                            </p>
                        </div>
                        ...
                        <form action="{{ route('admin.periods.store') }}" method="POST" class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div class="col-span-1">
                                    ...
                                    <x-text-input id="name" name="name" type="text" class="mt-1 block w-full" :value="old('name')" required placeholder="p.ej. 2026-I, U-2026" />
