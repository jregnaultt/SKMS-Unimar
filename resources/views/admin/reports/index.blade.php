    ...
    <div class="space-y-8 max-w-8xl mx-auto pb-12"
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-200 pb-5">
            <div>
                ...
                <p class="text-base text-slate-500 mt-1 font-medium">Filtra la productividad científica del decanato y genera documentos oficiales (PDF y Excel) en tiempo real</p>
            </div>
        </div>
        ...
        <div class="space-y-4">
            ...
            <div x-show="generating && !reportUrl"
                ...
                <div class="text-center sm:text-left space-y-1">
                    <h4 class="text-base font-bold text-slate-850">Compilando datos en segundo plano...</h4>
                    <p class="text-base text-slate-500 font-medium">Procesando y aplicando la maquetación institucional del reporte. No cierres esta pestaña.</p>
                </div>
            </div>
            ...
            <div x-show="successMessage"
                ...
                <div class="flex items-start">
                    ...
                    <div>
                        <h4 class="text-base font-bold text-emerald-900">Operación en curso</h4>
                        <p class="text-base text-emerald-800/90 font-medium mt-0.5" x-text="successMessage"></p>
                    </div>
                </div>
                ...
                <div x-show="reportUrl" class="pt-2 border-t border-emerald-200/40">
                    <a :href="reportUrl"
                       class="inline-flex items-center px-5 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white font-bold rounded-xl text-base uppercase tracking-wider transition shadow-sm hover:shadow-md">
            ...
            <div x-show="errorMessage"
                ...
                <div class="flex items-center">
                    ...
                    <span class="font-bold text-base" x-text="errorMessage"></span>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white border border-slate-200/80 shadow-sm rounded-2xl overflow-hidden">
            ...
            <form @submit.prevent="requestReport()" class="p-8 space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <!-- Programa Académico -->
                    <div>
                        <label for="program_id" class="block text-base font-bold text-slate-600 uppercase tracking-wider mb-2">Programa Académico</label>
                        <select id="program_id"
                                x-model="programId"
                                class="block w-full px-4 py-3 h-11 bg-white border border-slate-200 rounded-xl text-base focus:border-unimar-blue focus:outline-none focus:ring-2 focus:ring-[#0d4d98]/50 transition duration-150 text-slate-700 font-medium cursor-pointer">
                    ...
                    <!-- Período Académico -->
                    <div>
                        <label for="period_id" class="block text-base font-bold text-slate-600 uppercase tracking-wider mb-2">Período Académico</label>
                        <select id="period_id"
                                x-model="periodId"
                                class="block w-full px-4 py-3 h-11 bg-white border border-slate-200 rounded-xl text-base focus:border-unimar-blue focus:outline-none focus:ring-2 focus:ring-[#0d4d98]/50 transition duration-150 text-slate-700 font-medium cursor-pointer">
                    ...
                    <!-- Estado del Flujo -->
                    <div>
                        <label for="workflow_state" class="block text-base font-bold text-slate-600 uppercase tracking-wider mb-2">Estado del Flujo</label>
                    ...
                    <div>
                        <label class="block text-base font-bold text-slate-600 uppercase tracking-wider mb-3">Formato de Exportación</label>
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <label class="flex items-center p-3 bg-white border border-slate-200 rounded-xl hover:bg-slate-50/50 cursor-pointer transition">
                                ...
                                <div class="ml-3 text-base">
                                    ...
                                    <span class="block text-base text-slate-550 font-bold mt-0.5 uppercase tracking-wider">Diseño institucional de UNIMAR</span>
                                </div>
                            </label>
                            ...
                            <label class="flex items-center p-3 bg-white border border-slate-200 rounded-xl hover:bg-slate-50/50 cursor-pointer transition">
                                ...
                                <div class="ml-3 text-base">
                                    ...
                                    <span class="block text-base text-slate-550 font-bold mt-0.5 uppercase tracking-wider">Formato tabular de datos (.xlsx)</span>
                                </div>
                            </label>
                ...
                <div class="flex items-center justify-end space-x-3 pt-6 border-t border-slate-100">
                    <button type="submit"
                            :disabled="generating"
                            class="py-3 px-6 bg-unimar-blue hover:bg-unimar-blue/95 disabled:bg-slate-350 disabled:text-slate-500 disabled:cursor-not-allowed text-white font-bold rounded-xl text-base uppercase tracking-wider transition shadow-sm hover:shadow-md flex items-center justify-center min-w-48 h-11 cursor-pointer">
                        <svg aria-hidden="true" x-show="generating" class="animate-spin -ml-1 mr-3 h-4 w-4 text-white" fill="none" viewBox="0 0 24 24" style="display: none;">
                            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                            <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                        </svg>
