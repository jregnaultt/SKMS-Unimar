    ...
    <div class="space-y-6 max-w-8xl mx-auto pb-12">
        ...
        <div class="bg-white border border-slate-200/80 shadow-sm rounded-2xl overflow-hidden">
            <div class="p-6 border-b border-slate-100 bg-slate-50/50">
                <h3 class="text-lg font-bold text-slate-800 font-sans">Registrar Línea de Investigación</h3>
                <p class="text-base text-slate-550 font-bold uppercase tracking-wider mt-0.5">Asocia la nueva línea a un programa académico maestro y define su alcance temático</p>
            </div>

            <form action="{{ route('admin.lines.store') }}" method="POST" class="p-8 space-y-6">
                @csrf
