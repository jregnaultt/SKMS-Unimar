    ...
    <div class="space-y-6 max-w-4xl mx-auto pb-12">
        ...
        <div class="bg-white border border-slate-200/80 shadow-sm rounded-2xl overflow-hidden">
            <div class="p-6 border-b border-slate-100 bg-slate-50/50">
                ...
                <p class="text-xs text-slate-500 mt-0.5 font-medium">Asocia la nueva línea a un programa académico maestro y define su alcance temático</p>
            </div>
            ...
            <form action="{{ route('admin.lines.store') }}" method="POST" class="p-8 space-y-6">
                ...
                <div>
                    ...
                    <textarea id="description" 
                              ...
                              class="block w-full px-4 py-2.5 bg-white border border-slate-200 rounded-xl text-sm focus:border-unimar-blue focus:ring focus:ring-unimar-blue/10 transition duration-150 text-slate-700 font-medium placeholder-slate-400">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="text-xs text-rose-600 font-bold mt-1.5">{{ $message }}</p>
                    @enderror
                </div>
