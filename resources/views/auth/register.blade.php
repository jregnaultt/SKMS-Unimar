<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-5">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4" x-data="{ showPassword: false, showConfirmPassword: false }">
            <!-- Contraseña -->
            <div>
                <label for="password" class="block text-xs font-bold text-slate-600 uppercase tracking-wider mb-1.5 md:h-8 md:flex md:items-end">Contraseña</label>
                <div class="relative">
                    <input id="password" 
            ...
            <div>
                <label for="password_confirmation" class="block text-xs font-bold text-slate-600 uppercase tracking-wider mb-1.5 md:h-8 md:flex md:items-end">Confirmar Contraseña</label>
                <div class="relative">
